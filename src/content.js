...
export const CONTENT = {
  zh: {
    ...
    leaderboard: {
      ...
      nameRequired: '请输入名字',
      nameTooLong: '名字最多 24 个字符',
      rank: '#{rank}',
      scoreLine: '{score} 分',
      detailLine: '{seconds}s · {temperature} · 聚变 {fusionCount} 次',
    },
    death: {
      titles: {
        wall: '等离子体接触炉壁',
  ...
  ja: {
    ...
    leaderboard: {
      ...
      submitted: '登録済み',
      recentNames: '最近使った名前',
      noRecentNames: '最近の名前はまだありません',
      searchPlaceholder: '名前で検索',
      topScores: '最高スコア',
      empty: '記録はまだありません',
      loading: '読み込み中...',
      loadFailed: 'ランキングを読み込めません',
      submitFailed: '登録に失敗しました。あとでもう一度試してください',
      nameRequired: '名前を入力してください',
      nameTooLong: '名前は 24 文字以内です',
      rank: '#{rank}',
      scoreLine: '{score} 点',
      detailLine: '{seconds}s · {temperature} · 核融合 {fusionCount} 回',
    },
    death: {
      titles: {
        wall: 'プラズマが炉壁に接触',
